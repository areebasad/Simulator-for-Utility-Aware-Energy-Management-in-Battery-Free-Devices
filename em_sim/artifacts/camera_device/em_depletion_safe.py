...
class DepletionSafe(EnergyManager):    
    ...
    def __init__(self, config: Dict[str, Any], buffer, scheduler):
        ...
        self.regulator_eta = 0.8                            # This is different to what we assume in simulation, Boost Converter Regulator efficiency
    ...
    def findBestIn(self, startSlot, numSlots, startVc):
        ...
        maxIn = self.max_current_amp    # Binary Search upper bound on consumption
        minIn = self.sleep_current_amp  # Binary Search lower bound
        ...
        while abs(maxIn - minIn) > self.simulation_ibal_tolerance:
            ...
            for ds in range(numSlots):
                ...
                Vc = self.simulate_newton(
                    ...
                    In * self.dc_dc_voltage, self.regulator_eta)
