...
# 4. Do for all slots
#
# Step B: Equal weights of all slots -> will automatically fall back to DS
#  Multiple Raise all slots
#
# Step C. Takes "Temproray Max Current Cosnumption MCC-A" as an input, fills first all slots until MCC-A and then again does the binary search to fill up until actual MCC

# Performs MultiRase and afterwards singleRaise
"""
